...
<section class="panel">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="info1-tab" data-toggle="tab" href="#info1" role="tab" aria-controls="info1" aria-selected="true" style="color:black"><strong>PROGRESS</strong></a>
        </li>
        <?php
        if ($nomorQN != '412') {
        ?>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>proyek/edit_2/<?= $proyek->getRow()->id_pkp ?>" role="tab" aria-controls="info2" aria-selected="true" style="color:black"><strong>PERMASALAHAN </strong></a>
            </li>
        <?php } ?>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>proyek/edit_6/<?= $proyek->getRow()->id_pkp ?>" role="tab" aria-controls="info6" aria-selected="true" style="color:black"><strong>MONITORING KARYAWAN</strong></a>
        </li>
        <?php
        if ($nomorQN != '412') {
        ?>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>proyek/edit_3/<?= $proyek->getRow()->id_pkp ?>" role="tab" aria-controls="info3" aria-selected="true" style="color:black"><strong>DATA UMUM & FOTO</strong></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>proyek/edit_4/<?= $proyek->getRow()->id_pkp ?>" role="tab" aria-controls="info4" aria-selected="true" style="color:black"><strong>DATA TEKNIS</strong></a>
            </li>
        <?php } ?>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>proyek/edit_5/<?= $proyek->getRow()->id_pkp ?>" role="tab" aria-controls="info5" aria-selected="true" style="color:black"><strong>MONITORING DCR</strong></a>
        </li>
            ...
            <div class="tab-pane active" id="info1" role="tabpanel" aria-labelledby="info1-tab">
                <div>
                    <div class="d-flex flex-row pull-right">
                        <div class="m-l-10 align-self-center">
                            ...
                            <div id="userbox" class="userbox">
                                <?php
                                if ($proyek->getRow()->validasi_kapro > 0 and level_user('proyek', 'data', $kategoriQNS, 'add') > 0) {
                                ?>
                                    <a class="btn btn-success" data-toggle="modal" data-target="#tambahData3" style="font-size: 12px;color:white"> UPD. PROGRESS</a>
                                <?php } ?>
                                <?php
                                if (level_user('kadiv', 'index', $kategoriQNS, 'read') > 0) {
                                ?>
                                    <a class="btn btn-success" data-toggle="modal" data-target="#tambahData4" style="font-size: 12px;color:white"> CLOSE PKP</a>
                                <?php } ?>
                                <?php
                                if ($proyek->getRow()->validasi_kapro < 1 and level_user('kapro', 'index', $kategoriQNS, 'read') > 0) {
                                ?>
                                    <a class="btn btn-success" data-toggle="modal" data-target="#tambahData5" style="font-size: 12px;color:white"> VALIDASI</a>
                                <?php } ?>
                                ...
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        <li class="divider"></li>
                                        <li>
                                            <a class="btn btn-info" href="<?= base_url() ?>proyek/xls1/<?= $proyek->getRow()->id_pkp ?>" style="font-size: 12px;color:black"> XLS</a>
                                        </li>
                                        <li>
                                            <a class="btn btn-info" href="<?= base_url() ?>proyek/pdf1/<?= $proyek->getRow()->id_pkp ?>" style="font-size: 12px;color:black" target="_blank"> PDF</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="table-scrollable" style="height: 490px;width:100%">
                        <table cellspacing="0" id="table-basic" class="table table-sm table-bordered table-striped" style="min-width: 1200px;width:120%">
                            <thead style="background-color:#1b3a59;color:white;">
                                <tr>
                                    <th style="vertical-align: middle;text-align:center;width:3%;" rowspan="2">NO</th>
                                    <th style="vertical-align: middle;text-align:center;width:30%;" rowspan="2">Nama Paket</th>
                                    ...
                                    <th style="vertical-align: middle;text-align:center;width:5%;" rowspan="2">Sisa Progress</th>
                                    <th style="text-align:center;vertical-align: middle;" colspan="2">Kontrak Induk</th>
                                    <th style="vertical-align: middle;text-align:center;width:5%;" rowspan="2">Keterangan</th>
                                    <th style="text-align:center" colspan="2">Addendum</th>
                                    <th style="vertical-align: middle;text-align:center;width:5%;" rowspan="2">Sisa Waktu (Hr)</th>
                                    <th style="vertical-align: middle;text-align:center;width:5%;" rowspan="2">Target Per Bulan</th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($paket as $det) { ?>
                                    <tr>
                                        ...
                                        <th style="color: dimgrey;width:30%;word-wrap:break-word;font-size:13px"><?= $det->paket; ?><br><b style="font-weight: 600;font-size:12px;"><?= $det->kode_pt; ?></b></th>
                                        <td style="text-align: right;width:5%;"><?= number_format($det->bobot_pg, 2, ",", "."); ?></td>
                                        <td style="text-align: right;background-color:#A9A9A9;border-color:#A9A9A9;width:5.5%;"><?= number_format($det->rensd_mgll, 2, ",", "."); ?></td>
                                        <td style="text-align: right;background-color:#A9A9A9;border-color:#A9A9A9;width:5.5%;"><?= number_format($det->rilsd_mgll, 2, ",", "."); ?></td>
                                        <?php if ($det->devsd_mgll < 0) { ?>
                                            <td style="text-align: right;color:crimson;background-color:#A9A9A9;border-color:#A9A9A9;width:5.5%;"><b><?= number_format($det->devsd_mgll, 2, ",", "."); ?></b></td>
                                        <?php
                                        } else { ?>
                                            <td style="text-align: right;background-color:#A9A9A9;border-color:#A9A9A9;width:5.5%;"><?= number_format($det->devsd_mgll, 2, ",", "."); ?></td>
                                        <?php } ?>
                                        <td style="text-align: right;width:5.5%;"><?= number_format($det->ren_mgini, 2, ",", "."); ?></td>
                                        <td style="text-align: right;width:5.5%;"><?= number_format($det->ril_mgini, 2, ",", "."); ?></td>
                                        <?php if ($det->dev_mgini < 0) { ?>
                                            <td style="text-align: right;color:crimson;width:5.5%;"><b><?= number_format($det->dev_mgini, 2, ",", "."); ?></b></td>
                                        <?php
                                        } else { ?>
                                            <td style="text-align: right;width:5.5%;"><?= number_format($det->dev_mgini, 2, ",", "."); ?></td>
                                        <?php } ?>
                                        <td style="text-align: right;background-color:#C0C0C0;border-color:#C0C0C0;width:5.5%;"><?= number_format($det->rensd_mgini, 2, ",", "."); ?></td>
                                        <td style="text-align: right;background-color:#C0C0C0;border-color:#C0C0C0;width:5.5%;"><?= number_format($det->rilsd_mgini, 2, ",", "."); ?></td>
                                        <?php if ($det->devsd_mgini < 0) { ?>
                                            <td style="text-align: right;color:crimson;background-color:#C0C0C0;border-color:#C0C0C0;width:5.5%;"><b><?= number_format($det->devsd_mgini, 2, ",", "."); ?></b></td>
                                        <?php
                                        } else { ?>
                                            <td style="text-align: right;background-color:#C0C0C0;border-color:#C0C0C0;width:5.5%;"><?= number_format($det->devsd_mgini, 2, ",", "."); ?></td>
                                        <?php } ?>
                                        <td style="text-align: right;width:5%;"><?= number_format($det->sisa_bobotpg, 2, ",", "."); ?></td>
                                        <?php if ($det->tgl_mulai > 0) { ?>
                                            <td style="text-align: center;width:8%;"><?= (date('d/m/y', strtotime($det->tgl_mulai))); ?></td>
                                            <td style="text-align: center;width:8%;"><?= (date('d/m/y', strtotime($det->tgl_selesai))); ?></td>
                                        ...
                                        <?php if ($det->tgl_sadd > 0) { ?>
                                            ...
                                            <td style="text-align: center;width:8%;"><?= (date('d/m/y', strtotime($det->tgl_sadd))); ?></td>
                                            <td style="text-align: center;width:8%;"><?= (date('d/m/y', strtotime($det->tgl_fadd))); ?></td>
                                        ...
                                        <?php } else { ?>
                                            <td></td>
                                        <?php } ?>
                                        <td style="text-align: right;width:5%;"><?= number_format($det->target_minggu, 2, ",", "."); ?></td>
                            ...
                            <footer>
                                <?php foreach ($proyek2 as $det2) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: right;background-color:#A9A9A9;border-color:#A9A9A9;"><?= number_format($det2->rensd_mgll, 2, ",", "."); ?></td>
                                        <td style="text-align: right;background-color:#A9A9A9;border-color:#A9A9A9;"><?= number_format($det2->rilsd_mgll, 2, ",", "."); ?></td>
                                        <?php if ($det2->devsd_mgll < 0) { ?>
                                            <td style="text-align: right;color:crimson;background-color:#A9A9A9;border-color:#A9A9A9;"><b><?= number_format($det2->devsd_mgll, 2, ",", "."); ?></b></td>
                                        <?php
                                        } else { ?>
                                            <td style="text-align: right;background-color:#A9A9A9;border-color:#A9A9A9;"><?= number_format($det2->devsd_mgll, 2, ",", "."); ?></td>
                                        <?php } ?>
                                        ...
                                        <?php if ($det2->dev_mgini < 0) { ?>
                                            <td style="text-align: right;color:crimson;"><b><?= number_format($det2->dev_mgini, 2, ",", "."); ?></b></td>
                                        <?php
                                        } else { ?>
                                            <td style="text-align: right;"><?= number_format($det2->dev_mgini, 2, ",", "."); ?></td>
                                        <?php } ?>
                                        <td style="text-align: right;background-color:#C0C0C0;border-color:#C0C0C0"><?= number_format($det2->rensd_mgini, 2, ",", "."); ?></td>
                                        <td style="text-align: right;background-color:#C0C0C0;border-color:#C0C0C0"><?= number_format($det2->rilsd_mgini, 2, ",", "."); ?></td>
                                        <?php if ($det2->devsd_mgini < 0) { ?>
                                            <td style="text-align: right;color:crimson;background-color:#C0C0C0;border-color:#C0C0C0;"><b><?= number_format($det2->devsd_mgini, 2, ",", "."); ?></b></td>
                                        <?php
                                        } else { ?>
                                            <td style="text-align: right;background-color:#C0C0C0;border-color:#C0C0C0;"><?= number_format($det2->devsd_mgini, 2, ",", "."); ?></td>
                                        <?php } ?>
                                        <td style="text-align: right;"><?= number_format($det2->sisa_bobotpg, 2, ",", "."); ?></td>
                                        <?php if ($det2->tgl_mulai > 0) { ?>
                                            <td style="text-align: center;"><?= (date('d/m/y', strtotime($det2->tgl_mulai))); ?></td>
                                            <td style="text-align: center;"><?= (date('d/m/y', strtotime($det2->tgl_selesai))); ?></td>
                                        <?php } else { ?>
                                            <td></td>
                                            <td></td>
                                        <?php } ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="width: 15%;vertical-align: middle;">
                                                <a style="font-size: 12px;" href="<?= base_url() ?>proyek/marketing/<?= $det->id_pkp ?>"><?= $det->alias ?></a>
                                            </td>
    ...
    <div class="modal-dialog" style="width:90%">
        <div class="modal-content">
            <section class="panel panel-primary">
                <?= form_open('proyek/upl_progress', ' id="FormulirTambah3"'); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group excelfile">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="hidden" name="id_pkp" value="<?= esc($proyek->getRow()->id_pkp) ?>" class="form-control" required />
                            ...
                            <div class="form-group excelfile">
                                ...
                                <a style="font-size:12px;" class="btn btn-warning" href="<?= base_url() ?>proyek/xls1/<?= $proyek->getRow()->id_pkp ?>"><i class="fa fa-download"></i> Download Format</a>
...
<div class="modal fade" id="tambahData4" tabindex="1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:90%">
        <div class="modal-content">
            <section class="panel panel-primary">
                <?= form_open('proyek/upd_close_pkp', ' id="FormulirTambah4"'); ?>
                <h2 class="panel-title">UBAH STATUS PROYEK</h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group excelfile">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    ?>
                                    <input type="hidden" name="id_pkp" value="<?= esc($proyek->getRow()->id_pkp) ?>" class="form-control" placeholder="Masukkan Nomor Dokumen" required />
                                    <input type="text" name="tgl_close" value="<?= $tanggal_close ?>" class="form-control tanggal" data-plugin-datepicker data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask />
                                </div>
                ...
                <footer class="panel-footer">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button class="btn btn-primary modal-confirm" style="font-size: 12px;vertical-align: middle" type="submit" id="submitform4">Submit</button>
                            <button class="btn btn-default" style="font-size: 12px;vertical-align: middle" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                </footer>
...
<div class="modal fade" id="tambahData5" tabindex="1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:90%">
        <div class="modal-content">
            <section class="panel panel-primary">
                <?= form_open('proyek/validasi_kapro1', ' id="FormulirTambah5"'); ?>
                <h2 class="panel-title">UBAH STATUS PROYEK</h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group excelfile">
                                ...
                                <div class="col-sm-9">
                                    <select data-plugin-selectTwo class="form-control" name="validasi" placeholder="Silahkan pilih Kategori Dokumen" required>
                ...
                <footer class="panel-footer">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button class="btn btn-primary modal-confirm" style="font-size: 12px;vertical-align: middle" type="submit" id="submitform5">Submit</button>
                            <button class="btn btn-default" style="font-size: 12px;vertical-align: middle" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                </footer>
