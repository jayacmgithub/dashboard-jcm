                                ...
                                <?php foreach ($proyek2 as $det2) { ?>
                                    <tr>
                                        ...
                                        <?php if ($det2->devsd_mgll < 0) { ?>
                                            <td
                                                style="text-align: right;color:crimson;background-color:#A9A9A9;border-color:#A9A9A9;">
                                        ...
                                        <?php if ($det2->devsd_mgini < 0) { ?>
                                            <td
                                                style="text-align: right;color:crimson;background-color:#C0C0C0;border-color:#C0C0C0;">
