                ...
                <div class="table-responsive">
                    <table class="table table-bordered dataTable">
                        <thead style="background-color:#1b3a59">
                                ...
                                <?php foreach ($dbdcr as $det) { ?>
                                    <tr>
                                        ...
                                        if ($det->tgl_max > 0) {
                                            ...
                                            $selisih = ((abs(strtotime($proyek->row()->tgl_ubah_dcr) - strtotime($now1))) / 86400 - 1);
                                        } else {
                                            $tgl_akhir_dcr = '';
                                            $selsisih = 0;
                                        }
                                    ...
                                    <?php foreach ($dbdcr as $det) { ?>
                                        ...
                                        <td style="vertical-align: middle;background-color:white;text-align:right;">
                                            <a style="font-size: 14px;font-weight: 100;color:black;"><?php echo number_format($det->total1, 0, '.', ',') ?> Dokumen</a>
                                            </br>
                                            <a style="font-size: 14px;font-weight: 100;color:black"><?php echo number_format($det->telat, 0, '.', ',') ?> Dokumen</a>
                                            </br>
                                            <a style="font-size: 14px;font-weight: 100;color:black"><?php echo number_format($det->upload, 0, '.', ',') ?> Dokumen</a>
                                            </br>
                                            <a style="font-size: 14px;font-weight: 100;color:black"><?php echo number_format($det->total1 - $det->upload, 0, '.', ',') ?> Dokumen</a>
                                            </br>
                                            <a style="font-size: 14px;font-weight: 100;color:black"><?php echo number_format($det->blm_kembali, 0, '.', ',') ?> Dokumen</a>
                                        </td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
                            <?php } else { ?>
                                <tr>
                                    <th style="width:100%;text-align:center;background:#fff;color:#000" colspan="4">PROYEK TIDAK MENGGUNAKAN DCR</th>
                                </tr>
                            <?php } ?>
