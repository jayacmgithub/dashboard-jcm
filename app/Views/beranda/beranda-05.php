...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <?php if ($pro1 == 1) { ?>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>dashboard/beranda_01" role="tab" aria-controls="gedung1" aria-selected="true">GEDUNG 1</a>
        </li>
    <?php } ?>
    <?php if ($pro2 == 1) { ?>
        <li class="nav-item">
    ...
    <?php if ($pro3 == 1) { ?>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>dashboard/beranda_03" role="tab" aria-controls="gedung3" aria-selected="true">KTL 1</a>
        </li>
    <?php } ?>
    <?php if ($pro4 == 1) { ?>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>dashboard/beranda_04" role="tab" aria-controls="gedung4" aria-selected="true">KTL 2</a>
        </li>
    <?php } ?>
    <li class="nav-item">
        <a class="nav-link active" id="gedung5-tab" data-toggle="tab" href="#gedung5" role="tab" aria-controls="gedung5" aria-selected="true">TRANSPORTASI 1</a>
    </li>
    <?php if ($pro6 == 1) { ?>
        <li class="nav-item">
        ...
        <div class="tab-pane active" id="gedung5" role="tabpanel" aria-labelledby="gedung5-tab">
            ...
            <div>
                ...
                <div class="table-scrollable" style="height: 480px;width:100%">
                    <table cellspacing="0" id="table-basic" class="table table-sm table-bordered table-striped" style="width:100%">
