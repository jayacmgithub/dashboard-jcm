...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <?php } ?>
    <li class="nav-item">
        <a class="nav-link active" id="gedung3-tab" data-toggle="tab" href="#gedung3" role="tab" aria-controls="gedung3" aria-selected="true">KTL 1 <?php $pro4 . ':' . $pro3 ?></a>
    </li>
    <?php if ($pro4 == 1) { ?>
        <li class="nav-item">
        ...
        <div class="tab-pane active" id="gedung3" role="tabpanel" aria-labelledby="gedung3-tab">
            ...
            <div>
                ...
                <div class="table-scrollable" style="height: 480px;width:100%">
                    <table cellspacing="0" id="table-basic" class="table table-sm table-bordered table-striped" style="min-width: 1200px;width:100%">
