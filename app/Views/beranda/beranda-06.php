...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <?php } ?>
    <li class="nav-item">
        <a class="nav-link active" id="gedung6-tab" data-toggle="tab" href="#gedung6" role="tab" aria-controls="gedung6" aria-selected="true">TRANSPORTASI 2</a>
    </li>
    <?php if ($pro7 == 1) { ?>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url() ?>dashboard/beranda_07" role="tab" aria-controls="gedung7" aria-selected="true">MARKETING</a>
        </li>
    <?php } ?>
</ul>
