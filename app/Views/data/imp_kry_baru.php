    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="info1-tab" data-toggle="tab" href="#info1" role="tab" aria-controls="info1"
                aria-selected="true">KARYAWAN BARU</a>
        </li>
    </ul>
    <!--PROGRESS-->
            ...
            <div class="col-md-12 text-right">
                ...
                if (level_user('data', 'hcm', $kategoriQNS, 'edit') > 0 and $total1 < 1) {
                    ...
                    <a class="btn btn-warning" style="font-size: 12px;"
                        href="<?php echo base_url() ?>excel/formKaryawanBr.xlsx" target="_blank"><i
            ...
            <table class="table table-bordered table-hover table-striped" id="importdata1">
                <thead>
                    <tr>
                        ...
                        <th style="vertical-align:middle">PKP</th>
                        <th style="vertical-align:middle">NAMA</th>
                        <th style="vertical-align:middle">TGL MASUK<br>AKHIR KONTRAK<br>TGL LAHIR</th>
                        ...
                        <th style="vertical-align:middle">STS KARYAWAN</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript">
    ...
    var tableimport = $('#importdata1').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?= base_url() ?>laporan/dataimport1",
            "type": "GET"
        },
        "columnDefs": [{
            "targets": [0, 1, 2, 3, 4],
