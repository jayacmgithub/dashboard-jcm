...
<section class="panel">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane active" id="info1" role="tabpanel" aria-labelledby="info1-tab">
            ...
            if (level_user('qs', 'index', $kategoriQNS, 'read') > 0 and $total1 < 1) {
                echo form_open(base_url('proyek/upload_mon_1'), ' id="FormulirUpload" enctype="multipart/form-data"');
            } else {
                if (level_user('qs', 'index', $kategoriQNS, 'read') > 0 and $total1 > 0 and $total2 < 1) {
                    echo form_open(base_url('proyek/proses_mon_1'), ' id="FormulirUpload" enctype="multipart/form-data"');
                } else {

                    if (level_user('qs', 'index', $kategoriQNS, 'read') > 0 and $total1 > 0 and $total2 > 0) {
        ...
        <?php
        if (level_user('qs', 'index', $kategoriQNS, 'read') > 0 and $total1 > 0) {
            ?>
            <h4> Total Data : <?php echo $total1 ?> record</h4>
            <h4> Total Error : <?php echo $total2 ?> field</h4>
