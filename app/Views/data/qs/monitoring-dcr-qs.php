...
<section class="panel">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="info1-tab" data-toggle="tab" href="#info1" role="tab" aria-controls="info1" aria-selected="true">MONITORING DCR</a>
        </li>
    </ul>
                        ...
                        <thead style="background-color:#1b3a59">
                            ...
                            <tr>
                                ...
                                <td style="width: 40%;vertical-align: middle;background-color:white;" colspan="2">
                                    ...
                                    ?>
                                    <a style="font-size: 14px;font-weight: 100;color:black"><?= $tgl_mulai ?></a>
                                    </br>
                                    <a style="font-size: 14px;font-weight: 100;color:black"><?= $tgl_selesai ?></a>
                                </td>
                            ...
                            <tr>
                                <?php foreach ($mon_dcr1 as $mon1) { ?>
                                    ...
                                    <td style="width: 60%;vertical-align: middle;background-color:white;" colspan="2">
                                        <a style="font-size: 14px;font-weight: 100;color:black"><?= $tgl_awal_dcr ?></a>
                                        </br>
                                        <a <?= $gaya ?>><?= $tgl_akhir_dcr . ' (sudah ' . $selisih . ' hari dari tanggal diperbarui)' ?></a>
                                        </br>
                                        <a style="font-size: 14px;font-weight: 100;color:black"><?= $durasi ?> Hari</a>
                                        </br>
                                        <a style="font-size: 14px;font-weight: 100;color:black"><?= $rata2 ?> Dokumen</a>
                                    </td>
                            </tr>
                            ...
                            <td style="width: 40%;vertical-align: middle;text-align:left;background-color:white;">
                                ...
                                <br>
                                <div <?= $telat3 . ' ' . $telat ?> role="progressbar"> <span style="font-size: 12px;font-weight: 500;color:black;white-space: nowrap;"><?= number_format($per_telat, 2, ',', '.') ?>%</span></div>
                                <div <?= $abu2 . ' ' . $sisa_telat ?> role="progressbar"></div>

                                <div <?= $upload3 . ' ' . $upload ?> role="progressbar"> <span style="font-size: 12px;font-weight: 500;color:black;white-space: nowrap;"><?= number_format($per_upload, 2, ',', '.') ?>%</span></div>
                                <div <?= $abu2 . ' ' . $sisa_upload ?> role="progressbar"></div>

                                <div <?= $blm_upload3 . ' ' . $blm_upload ?> role="progressbar"> <span style="font-size: 12px;font-weight: 500;color:black;white-space: nowrap;"><?= number_format($per_blm_upload, 2, ',', '.') ?>%</span></div>
                                <div <?= $abu2 . ' ' . $sisa_blm_upload ?> role="progressbar"></div>

                                <div <?= $blm_kembali3 . ' ' . $blm_kembali ?> role="progressbar"> <span style="font-size: 12px;font-weight: 500;color:black;white-space: nowrap;"><?= number_format($per_blm_kembali, 2, ',', '.') ?>%</span></div>
                                <div <?= $abu2 . ' ' . $sisa_blm_kembali ?> role="progressbar"></div>
                            </td>
                            <td style="vertical-align: middle;background-color:white;text-align:right;">
                                <a style="font-size: 14px;font-weight: 100;color:black;"><?= number_format($mon1->total, 0, '.', ',') ?> Dokumen</a>
                                </br>
                                <a style="font-size: 14px;font-weight: 100;color:black"><?= number_format($mon1->telat, 0, '.', ',') ?> Dokumen</a>
                                </br>
                                <a style="font-size: 14px;font-weight: 100;color:black"><?= number_format($mon1->upload, 0, '.', ',') ?> Dokumen</a>
                                </br>
                                <a style="font-size: 14px;font-weight: 100;color:black"><?= number_format($mon1->total - $mon1->upload, 0, '.', ',') ?> Dokumen</a>
                                </br>
                                <a style="font-size: 14px;font-weight: 100;color:black"><?= number_format($mon1->blm_kembali, 0, '.', ',') ?> Dokumen</a>
                            </td>
                            </tr>
                        ...
                        <div class="col-md-6">
                            <div class="form-group excelfile">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="hidden" name="id_pkp58" value="<?= esc($proyek->getRow()->id_pkp) ?>" class="form-control" required />
                        ...
                        <div class="col-md-12">
                            <div class="form-group excelfile">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="tgl_mulai" value="<?= $tanggal_mulai ?>" class="form-control tanggal" data-plugin-datepicker data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask />
                                </div>
                            ...
                            <div class="form-group excelfile">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tgl_selesai" value="<?= $tanggal_selesai ?>" class="form-control tanggal" data-plugin-datepicker data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask />
                                </div>
                            ...
                            <div class="form-group mt-lg dtu_nama">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="warning" value="<?= $warning ?>" class="form-control" required />
                                </div>
                            </div>
                            <div class="form-group mt-lg dtu_nama">
