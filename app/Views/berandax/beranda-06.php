                                    ...
                                    <tr>
                                        <td style="border-right: 5px;width: 25%;vertical-align: middle;">
                                            <a style="font-size: 16px;font-weight: 400" class="link"
                                                href="<?php echo base_url() ?>proyek/edit_1/<?php echo $det->id_pkp ?>">
                                                <?php echo $det->alias ?>
                                            </a><br>
                                            <a style="font-size: 12px;font-weight: 400" class="link"
                                                href="<?php echo base_url() ?>proyek/edit_1/<?php echo $det->id_pkp ?>"><i>Last Upd:
                                                    <b>
                                                        <?php echo (date('d-M-Y', strtotime($det->tgl_ubah_progress))) ?>
                                                    </b>
                                                    <?php echo ' (Periode: ' . $det->bulan . '/' . $det->tahun . ')' ?>
                                                </i><small> <b>
                                                        <?php echo $valid ?>
                                                    </b></small></a>
                                        </td>
                                        <td style="border-left: 5px; width: 3%;vertical-align: middle;">
                                            <?php if ($det->devsd_mgini <= $det->late and $det->rensd_mgini > 0) { ?>
                                                <div class="notify"> <a
                                                        href="<?php echo base_url() ?>proyek/edit_2/<?php echo $det->id_pkp ?>"><span
                                                            class="heartbitM" data-toggle="tooltip" data-placement="top"
                                                            title="Terdapat Pekerjaan sudah telat lebih dari <?php echo number_format($det->late, 2) ?>%"></span>
                                                ...
                                                <?php if ($det->devsd_mgini > $det->late and $det->devsd_mgini <= $det->warning and $det->rilsd_mgini < 100) { ?>
                                                    <div class="notify"> <a
                                                            href="<?php echo base_url() ?>proyek/edit_2/<?php echo $det->id_pkp ?>"><span
                                                                ...
                                                                title="Terdapat Pekerjaan yang berpotensi terlambat, batas telat <?php echo number_format($det->late, 2) ?>%"></span>
                                                            <span class="pointK"></span></a> </div>
                                                <?php } else { ?>
                                                    <?php if ($det->alert > 0) { ?>
                                                        <div class="notify"> <a
                                                                href="<?php echo base_url() ?>proyek/edit_2/<?php echo $det->id_pkp ?>"> </a>
                                                        </div>
                                                    <?php }
                                                }
                                            } ?>
                                        ...
                                        <td style="width: 20%;line-height: 10px; vertical-align: middle;">
                                            ...
                                            <div class="progress-bar bg-info3 wow animated progress-animated" <?php echo $rencana ?>
                                                role="progressbar"> <span
                                                    style="font-size: 12px;font-weight: 600;color:#fafafa;white-space: nowrap;">
                                                    <?php echo number_format($det->rensd_mgini, 2) ?> %
                                                </span></div>
                                            <div class="progress-bar bg-infoA wow animated progress-animated" <?php echo $rencana2 ?>role="progressbar"> <span
                                            ...
                                            if ($det->devsd_mgini < 0) { ?>
                                                ...
                                                <div class="progress-bar bg-info2 wow animated progress-animated" role="progressbar"
                                                    <?php echo $real ?> role="progressbar"> <span
                                                        style="font-size: 12px;font-weight: 500;color:black;white-space: nowrap">
                                                        <?php echo number_format($det->rilsd_mgini, 2) ?> %
                                                    </span> </div>
                                                <div class="progress-bar bg-infoM wow animated progress-animated" <?php echo $deviasi2 ?>role="progressbar"> <span
                                                        style="font-size: 12px;font-weight: 600;color:#fafafa;white-space: nowrap;"></span>
                                                </div>
                                                <div class="progress-bar bg-infoA wow animated progress-animated" <?php echo $realisasi2 ?>role="progressbar"> <span
                                                        style="font-size: 12px;font-weight: 600;color:#fafafa;white-space: nowrap;"></span>
                                                </div>
                                                ...
                                                if ($det->devsd_mgini > 1) {
                                                    ...
                                                    <div class="progress-bar bg-infoH wow animated progress-animated" <?php echo $deviasi2 ?>role="progressbar"> <span
                                                            style="font-size: 12px;font-weight: 600;color:#fafafa;white-space: nowrap;"></span>
                                                    </div>
                                                    <div class="progress-bar bg-infoA wow animated progress-animated" <?php echo $realisasi2 ?>role="progressbar"> <span
                                                            style="font-size: 12px;font-weight: 600;color:#fafafa;white-space: nowrap;"></span>
                                        ...
                                        <?php } ?>
                                        <td style="text-align:center;width: 5%;vertical-align: middle; font-size:medium;"><b>
                                                <?php echo number_format($det->late, 2) ?>%
                                            </b></span></td>
                                    </tr>
